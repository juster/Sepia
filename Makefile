...
#     NAME => q[Sepia]
#     PREREQ_PM => { Scalar::Util=>q[0], PadWalker=>q[0], B::Module::Info=>q[0], Data::Dumper=>q[0], Sub::Uplevel=>q[0] }
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    - Sean O'\''Rourke <seano@cpan.org>' >> META_new.yml
...
ppd:
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,65,0,0">' > $(DISTNAME).ppd
